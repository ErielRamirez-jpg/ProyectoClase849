...
const skincareSlice = createSlice({
  ...
  initialState,
  reducers: {
    // Acción para crear productos localmente
    ...
    // NUEVA ACCIÓN: Para insertar productos que ya tienen ID de Supabase
    addProductFromDatabase: (state, action: PayloadAction<Product>) => {
